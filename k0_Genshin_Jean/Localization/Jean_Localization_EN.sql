...
values  ('LOC_LEADER_K0_JEAN_NAME', 'Jean Gunnhildr'),
...
-- first meeting ---------------------------------------------
	-- ai greets player
	('LOC_DIPLO_FIRST_MEET_LEADER_K0_JEAN_ANY',
	...
	('LOC_DIPLO_FIRT_MEET_VISIT_RECIPIENT_LEADER_K0_JEAN_ANY',
	...
	('LOC_DIPLO_FIRST_MEET_NEAR_INITIATOR_POSITIVE_LEADER_K0_JEAN_ANY',
	'Yes, I would like that.'),

	-- ai exchange capital
	('LOC_DIPLO_FIRST_MEET_NO_MANS_INFO_EXCHANGE_LEADER_K0_JEAN_ANY',
	'We should share our maps. I''m sure our people would love to visit your capital.'),

-- greetings -------------------------------------------------
	-- happy
	('LOC_DIPLO_GREETING_LEADER_K0_JEAN_HAPPY',
	'Greetings, Traveller. Let''s give it our all today.'),

	-- unhappy
	('LOC_DIPLO_GREETING_LEADER_K0_JEAN_UNHAPPY',
	'What do you want now?'),

-- delegation ------------------------------------------------
	-- ai accepts
	('LOC_DIPLO_ACCEPT_DELEGATION_FROM_HUMAN_LEADER_K0_JEAN_ANY',
	'Your people are welcome in Mondstadt, I will personally give them a tour of the city.'),

	-- ai rejects
	('LOC_DIPLO_REJECT_DELEGATION_FROM_HUMAN_LEADER_K0_JEAN_ANY',
	'I''m busy at the moment.'),

	-- ai requests
	('LOC_DIPLO_DELEGATION_FROM_AI_LEADER_K0_JEAN_ANY',
	'I''ve sent you a delegation, along with gifts of Dandelion Wine and Mondstadt Hash Browns. I hope you will accept them.'),

-- open borders ----------------------------------------------
	-- ai accepts
	('LOC_DIPLO_ACCEPT_OPEN_BORDERS_FROM_HUMAN_LEADER_K0_JEAN_ANY',
	'''Freedom'' is the core of Mondstadt''s ideals. Your people are free to come and go as they please.'),

	-- ai rejects
	('LOC_DIPLO_REJECT_OPEN_BORDERS_FROM_HUMAN_LEADER_K0_JEAN_ANY',
	'For the safety of Mondstadt''s people, I must refuse.'),

	-- ai requests
	('LOC_DIPLO_OPEN_BORDERS_FROM_AI_LEADER_K0_JEAN_ANY',
	'The people of Mondstadt would like to visit your nation. Would you allow them within your borders?'),

-- friend ----------------------------------------------------
	-- ai accepts
	('LOC_DIPLO_ACCEPT_DECLARE_FRIEND_FROM_HUMAN_LEADER_K0_JEAN_ANY',
	...
	-- ai rejects
	('LOC_DIPLO_REJECT_DECLARE_FRIEND_FROM_HUMAN_LEADER_K0_JEAN_ANY',
	'On behalf of Mondstadt, I must refuse.'),

	-- ai requests
	('LOC_DIPLO_DECLARE_FRIEND_FROM_AI_LEADER_K0_JEAN_ANY',
...
-- troops near border ----------------------------------------
	...
	('LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_AI_RESPONSE_NEGATIVE_LEADER_K0_JEAN_ANY',
	'Your land and people deserve to be free, and I will see it so.'),

-- settling near border --------------------------------------
	-- ai warns player // happy
	('LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_LEADER_K0_JEAN_HAPPY',
	...
	('LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_LEADER_K0_JEAN_UNHAPPY',
	...
	('LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_POSITIVE_LEADER_K0_JEAN_HAPPY',
	...
	('LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_POSITIVE_LEADER_K0_JEAN_UNHAPPY',
...
--------------------------------------------------------------
		...
		('LOC_PEDIA_LEADERS_PAGE_LEADER_K0_JEAN_CHAPTER_HISTORY_PARA_1',
		...
		('LOC_PEDIA_LEADERS_PAGE_LEADER_K0_JEAN_CHAPTER_HISTORY_PARA_2',
		...
		('LOC_PEDIA_LEADERS_PAGE_LEADER_K0_JEAN_CHAPTER_HISTORY_PARA_3',
		...
		('LOC_PEDIA_LEADERS_PAGE_LEADER_K0_JEAN_CHAPTER_HISTORY_PARA_4',
		...
		('LOC_PEDIA_LEADERS_PAGE_LEADER_K0_JEAN_CHAPTER_HISTORY_PARA_5',
		...
		('LOC_PEDIA_LEADERS_PAGE_LEADER_K0_JEAN_CHAPTER_HISTORY_PARA_6',
		...
		('LOC_PEDIA_LEADERS_PAGE_LEADER_K0_JEAN_CHAPTER_HISTORY_PARA_7',
			'"You have to give your all to do the right thing. Always."'),
		('LOC_PEDIA_LEADERS_PAGE_LEADER_K0_JEAN_CHAPTER_HISTORY_PARA_8',
			'(Excerpt from Jean''s ingame story.)'),


		('LOC_PEDIA_UNITS_PAGE_UNIT_K0_JEAN_UU_CHAPTER_HISTORY_PARA_1',
		...
		('LOC_PEDIA_UNITS_PAGE_UNIT_K0_JEAN_UU_CHAPTER_HISTORY_PARA_2',
			'The knights act as the lawmen of Mondstadt, keeping its citizens safe and creating and upholding laws for all.'),
		('LOC_PEDIA_UNITS_PAGE_UNIT_K0_JEAN_UU_CHAPTER_HISTORY_PARA_3',
		...
		('LOC_PEDIA_UNITS_PAGE_UNIT_K0_JEAN_UU_CHAPTER_HISTORY_PARA_4',
