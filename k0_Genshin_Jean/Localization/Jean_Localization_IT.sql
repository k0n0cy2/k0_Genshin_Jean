...
values  ('it_IT', 'LOC_LEADER_K0_JEAN_NAME', 'Jean Gunnhildr'),
	
		('it_IT', 'LOC_TRAIT_LEADER_K0_DANDELION_BREEZE_NAME',
			'Dandelion Breeze'),
		('it_IT', 'LOC_TRAIT_LEADER_K0_DANDELION_BREEZE_DESCRIPTION',
			'Jean''s units adjacent to any of her city centers or encampments heal at the end of each turn.'),

		('it_IT', 'LOC_BUILDING_K0_JEAN_FAVONIUS_HQ_NAME',
			'Knights of Favonius Headquarters'),
		('it_IT', 'LOC_BUILDING_K0_JEAN_FAVONIUS_HQ_DESCRIPTION',
		...
		-- agenda
		('it_IT', 'LOC_AGENDA_K0_JEAN_NAME',
			'Workoholic'),
		('it_IT', 'LOC_AGENDA_K0_JEAN_DESCRIPTION',
			'Likes players whose cities have high [ICON_Production] Production. Dislikes players who start wars.'),
	
		('it_IT', 'LOC_DIPLO_KUDO_LEADER_K0_JEAN_REASON_ANY',
			'(Your cities have high production)'),
		('it_IT', 'LOC_DIPLO_MODIFIER_K0_JEAN_HAPPY',
			'It''s good to see that your people are working hard.'),

		('it_IT', 'LOC_DIPLO_WARNING_LEADER_K0_JEAN_REASON_ANY',
			'(You have declared a surprise war.)'),
		('it_IT', 'LOC_DIPLO_MODIFIER_K0_JEAN_UNHAPPY',
			'Your actions threaten the peace and prosperity of all of Teyvat.'),

		-- load info
		('it_IT', 'LOC_LOADING_INFO_LEADER_K0_JEAN',
...
-- first meeting ---------------------------------------------
	-- ai greets player
	('it_IT', 'LOC_DIPLO_FIRST_MEET_LEADER_K0_JEAN_ANY',
	...
	('it_IT', 'LOC_DIPLO_FIRT_MEET_VISIT_RECIPIENT_LEADER_K0_JEAN_ANY',
	...
	('it_IT', 'LOC_DIPLO_FIRST_MEET_NEAR_INITIATOR_POSITIVE_LEADER_K0_JEAN_ANY',
	'Yes, I would like that.'),

	-- ai exchange capital
	('it_IT', 'LOC_DIPLO_FIRST_MEET_NO_MANS_INFO_EXCHANGE_LEADER_K0_JEAN_ANY',
	'We should share our maps. I''m sure our people would love to visit your capital.'),

-- greetings -------------------------------------------------
	-- happy
	('it_IT', 'LOC_DIPLO_GREETING_LEADER_K0_JEAN_HAPPY',
	'Greetings, Traveller. Let''s give it our all today.'),

	-- unhappy
	('it_IT', 'LOC_DIPLO_GREETING_LEADER_K0_JEAN_UNHAPPY',
	'What do you want now?'),

-- delegation ------------------------------------------------
	-- ai accepts
	('it_IT', 'LOC_DIPLO_ACCEPT_DELEGATION_FROM_HUMAN_LEADER_K0_JEAN_ANY',
	'Your people are welcome in Mondstadt, I will personally give them a tour of the city.'),

	-- ai rejects
	('it_IT', 'LOC_DIPLO_REJECT_DELEGATION_FROM_HUMAN_LEADER_K0_JEAN_ANY',
	'I''m busy at the moment.'),

	-- ai requests
	('it_IT', 'LOC_DIPLO_DELEGATION_FROM_AI_LEADER_K0_JEAN_ANY',
	'I''ve sent you a delegation, along with gifts of Dandelion Wine and Mondstadt Hash Browns. I hope you will accept them.'),

-- open borders ----------------------------------------------
	-- ai accepts
	('it_IT', 'LOC_DIPLO_ACCEPT_OPEN_BORDERS_FROM_HUMAN_LEADER_K0_JEAN_ANY',
	'''Freedom'' is the core of Mondstadt''s ideals. Your people are free to come and go as they please.'),

	-- ai rejects
	('it_IT', 'LOC_DIPLO_REJECT_OPEN_BORDERS_FROM_HUMAN_LEADER_K0_JEAN_ANY',
	'For the safety of Mondstadt''s people, I must refuse.'),

	-- ai requests
	('it_IT', 'LOC_DIPLO_OPEN_BORDERS_FROM_AI_LEADER_K0_JEAN_ANY',
	'The people of Mondstadt would like to visit your nation. Would you allow them within your borders?'),

-- friend ----------------------------------------------------
	-- ai accepts
	('it_IT', 'LOC_DIPLO_ACCEPT_DECLARE_FRIEND_FROM_HUMAN_LEADER_K0_JEAN_ANY',
	...
	-- ai rejects
	('it_IT', 'LOC_DIPLO_REJECT_DECLARE_FRIEND_FROM_HUMAN_LEADER_K0_JEAN_ANY',
	'On behalf of Mondstadt, I must refuse.'),

	-- ai requests
	('it_IT', 'LOC_DIPLO_DECLARE_FRIEND_FROM_AI_LEADER_K0_JEAN_ANY',
...
-- troops near border ----------------------------------------
	...
	('it_IT', 'LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_AI_RESPONSE_NEGATIVE_LEADER_K0_JEAN_ANY',
	'Your land and people deserve to be free, and I will see it so.'),

-- settling near border --------------------------------------
	-- ai warns player // happy
	('it_IT', 'LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_LEADER_K0_JEAN_HAPPY',
	...
	('it_IT', 'LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_LEADER_K0_JEAN_UNHAPPY',
	...
	('it_IT', 'LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_POSITIVE_LEADER_K0_JEAN_HAPPY',
	...
	('it_IT', 'LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_POSITIVE_LEADER_K0_JEAN_UNHAPPY',
	...
	('it_IT', 'LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_NEGATIVE_LEADER_K0_JEAN_HAPPY',
	'Try as I might, Mondstadt''s people are impossible to control.'),

	-- ai rejects player // unhappy
	('it_IT', 'LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_NEGATIVE_LEADER_K0_JEAN_UNHAPPY',
	'Mondstadt''s people are free to do as they please, I will make no effort to restrict that freedom.'),

-- trade -----------------------------------------------------
	-- player accepts deal // happy
	('it_IT', 'LOC_DIPLO_ACCEPT_MAKE_DEAL_FROM_AI_LEADER_K0_JEAN_HAPPY',
	'We''ve still got work to do. Let''s keep going.'),

	-- player accepts deal // unhappy
	('it_IT', 'LOC_DIPLO_ACCEPT_MAKE_DEAL_FROM_AI_LEADER_K0_JEAN_UNHAPPY',
	'There is still much to do.'),

	-- player rejects deal // happy
	('it_IT', 'LOC_DIPLO_REJECT_MAKE_DEAL_FROM_AI_LEADER_K0_JEAN_HAPPY',
	'I see. We will have to find better terms, then.'),

	-- player rejects deal // unhappy
	('it_IT', 'LOC_DIPLO_REJECT_MAKE_DEAL_FROM_AI_LEADER_K0_JEAN_UNHAPPY',
	'You would deny Mondstadt of a fair deal?'),

-- denounce --------------------------------------------------
	-- player denounces ai
	('it_IT', 'LOC_DIPLO_DENOUNCE_FROM_HUMAN_LEADER_K0_JEAN_ANY',
	'Know that should you threaten the peace and safety of Mondstadt''s people, I will be forced to retaliate.'),

	-- ai denounces player
	('it_IT', 'LOC_DIPLO_DENOUNCE_FROM_AI_LEADER_K0_JEAN_ANY',
...
--------------------------------------------------------------
		...
		('it_IT', 'LOC_PEDIA_LEADERS_PAGE_LEADER_K0_JEAN_CHAPTER_HISTORY_PARA_1',
		...
		('it_IT', 'LOC_PEDIA_LEADERS_PAGE_LEADER_K0_JEAN_CHAPTER_HISTORY_PARA_2',
		...
		('it_IT', 'LOC_PEDIA_LEADERS_PAGE_LEADER_K0_JEAN_CHAPTER_HISTORY_PARA_3',
		...
		('it_IT', 'LOC_PEDIA_LEADERS_PAGE_LEADER_K0_JEAN_CHAPTER_HISTORY_PARA_4',
		...
		('it_IT', 'LOC_PEDIA_LEADERS_PAGE_LEADER_K0_JEAN_CHAPTER_HISTORY_PARA_5',
		...
		('it_IT', 'LOC_PEDIA_LEADERS_PAGE_LEADER_K0_JEAN_CHAPTER_HISTORY_PARA_6',
		...
		('it_IT', 'LOC_PEDIA_LEADERS_PAGE_LEADER_K0_JEAN_CHAPTER_HISTORY_PARA_7',
			'"You have to give your all to do the right thing. Always."'),
		('it_IT', 'LOC_PEDIA_LEADERS_PAGE_LEADER_K0_JEAN_CHAPTER_HISTORY_PARA_8',
			'(Excerpt from Jean''s ingame story.)'),


		('it_IT', 'LOC_PEDIA_UNITS_PAGE_UNIT_K0_JEAN_UU_CHAPTER_HISTORY_PARA_1',
		...
		('it_IT', 'LOC_PEDIA_UNITS_PAGE_UNIT_K0_JEAN_UU_CHAPTER_HISTORY_PARA_2',
			'The knights act as the lawmen of Mondstadt, keeping its citizens safe and creating and upholding laws for all.'),
		('it_IT', 'LOC_PEDIA_UNITS_PAGE_UNIT_K0_JEAN_UU_CHAPTER_HISTORY_PARA_3',
		...
		('it_IT', 'LOC_PEDIA_UNITS_PAGE_UNIT_K0_JEAN_UU_CHAPTER_HISTORY_PARA_4',
